	...
	<div id="loginMsg"></div>
      ...
      <div id="sendResponse" class="formRow"></div>
        ...
        <p class="topLinks">
          ...
          <a class="topLink active" href="sudoku.php">sudoku</a>
        ...
        <p class="intro formRow">
          Selecione a data e a imagem em JPG do sudoku. A imagem enviada deve estar na proporção correta, sem espaços brancos fora das colunas
        </p>
